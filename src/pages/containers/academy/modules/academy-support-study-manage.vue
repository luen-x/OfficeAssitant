<template>
	<set-title title="自习室">
		<div class="g-flex v-academy-support-study-manage-contaniers">
...
import List from '@components/academy/support-study-manage/list';
import Filter from '@components/academy/support-study-manage/filter';

import navigator from '@extends/mixins/navigator';
import Tree from '@components/academy/support-study-manage/tree';
...
export default {
	...
	mixins: [navigator('ACADEMY_SUPPORT_STUDY_MANAGE')],
	data() {
		return {
			classList: [],
			isRender: false,
...
.v-academy-support-study-manage-contaniers{
	position: relative;
	height: 100%;
	width: 100%;
	min-width: 1064px;
