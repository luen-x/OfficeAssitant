...
<script>
import List from '@components/content/setoolkit-manage/list';
import Filter from '@components/content/setoolkit-manage/filter';
import Tree from '@components/content/setoolkit-manage/tree';
import navigator from '@extends/mixins/navigator';
import { OSS_SEARCH_EMPTY } from '@constants/constants';

export default {
	name: 'oa-content-setoolkit-manage',
	components: {
		"oa-list": List,
		"oa-filter": Filter,
		"oa-tree": Tree
	},
	mixins: [navigator('CONTENT_SETOOLKIT_MANAGE')],
	data() {
		return {
			classList: [],
			isRender: false,
