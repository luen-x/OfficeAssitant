...
<script>
import List from '@components/content/satoolkit-manage/list';
import Filter from '@components/content/satoolkit-manage/filter';
import Tree from '@components/content/satoolkit-manage/tree';
import navigator from '@extends/mixins/navigator';
import { OSS_SEARCH_EMPTY } from '@constants/constants';

export default {
	name: 'oa-content-satoolkit-manage',
	components: {
		"oa-list": List,
		"oa-filter": Filter,
		"oa-tree": Tree
	},
	mixins: [navigator('CONTENT_SATOOLKIT_MANAGE')],
	data() {
		return {
			classList: [],
			isRender: false,
