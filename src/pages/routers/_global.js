...
import { getItem, setItem, delItem, getDevice, getParseUrl, getUrlParam, defineProperty, loadCssCode } from '../utils/utils';
...
_global.safe = '';
_global.userType = '';
createLoginAuth(getItem(`staff_${_global.version}`) || {}, false);
