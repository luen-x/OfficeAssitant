...
<!--  eslint-disable  -->
	<div :class="wrapClasses" :style="styles">
		<div :class="classes">
			<div v-if="showSlotHeader" :class="[prefixCls + '-title']" ref="title"><slot name="header"/></div>
			<div v-if="showHeader" :class="[prefixCls + '-header']" ref="header" @mousewheel="handleMouseWheel">
				<table-head
...
ref="body" :style="bodyStyle" v-show="!((!!localeNoDataText && (!data || data.length === 0)) || (!!localeNoFilteredDataText && (!rebuildData || rebuildData.length === 0)))"
			...
			<div
				:class="[prefixCls + '-tip']" 
:style="bodyStyle" v-show="((!!localeNoDataText && (!data || data.length === 0)) || (!!localeNoFilteredDataText && (!rebuildData || rebuildData.length === 0)))"
                @scroll="handleBodyScroll">
				<table cellspacing="0" cellpadding="0" border="0">
					<tbody>
						<tr>
							<td :style="{'height':bodyStyle.height,'width':`${this.headerWidth}px`}">
								<span v-if="!data || data.length === 0" v-html="localeNoDataText"/>
								<span v-else v-html="localeNoFilteredDataText"/>
							</td>
						</tr>
					</tbody>
				</table>
			</div>
			<div :class="[prefixCls + '-fixed']" v-if="isLeftFixed" :style="fixedTableStyle">
				...
				<div :class="[prefixCls + '-fixed-body']" ref="fixedBody" :style="fixedBodyStyle" @mousewheel="handleFixedMousewheel" 
@DOMMouseScroll="handleFixedMousewheel">
			...
			<div :class="[prefixCls + '-fixed-right']" v-if="isRightFixed" :style="fixedRightTableStyle">
				<div v-if="showHeader" :class="fixedHeaderClasses">
					<table-head
						:prefix-cls="prefixCls"
                        fixed="right"
				...
				<div :class="[prefixCls + '-fixed-body']" ref="fixedRightBody" :style="fixedBodyStyle" @mousewheel="handleFixedMousewheel" 
@DOMMouseScroll="handleFixedMousewheel">
					<table-body
						:draggable="draggable"
                        fixed="right"
			...
			<div :class="[prefixCls + '-fixed-right-header']" v-if="isRightFixed" :style="fixedRightHeaderStyle"/>
			<div v-if="showSlotFooter" :class="[prefixCls + '-footer']" ref="footer"><slot name="footer"/></div>
		</div>
