import { Poptip, Icon, Dropdown, DropdownMenu, DropdownItem } from "iview";
...
export default {
	...
	methods: {
		...
		handleResetCur() {
			this.$store.commit("CONTENT_SETOOLKIT_SET_LIST_RESET", { type: this.type });
		},
		handleLinkTo() {
			this.$router.push("/");
		},
