			...
			<div class="__content-wrapper">
					...
					>
						<div slot-scope="it">
							<div class="__item-wrapper" @click="handleDetail(it)">
								...
								<div class="__item">
									<div class="__top" v-html="it.title" />
									<div class="__bottom">
										<div class="__bottom-e" v-html="it.staff_name" />
										<div class="__bottom-t" v-html="it.create_time" />
				...
				<div class="__right-wrapper">
					...
					<div class="__right-list">
						...
						<div v-if="list.length" class="g-tc">
							<span>暂无相关案例</span>
						</div>
					</div>
				</div>
...
export default {
	...
	computed: {
		...
		listInfo() {
			return this.$store.state.contentSearchResult.listInfo[7];
		},
		keyword() {
