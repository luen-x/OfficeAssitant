<template>
	<vc-paging
		...
		mode="table"
		class="g-m-t-20 v-content-setoolkit-manage-list satoolkit-wrapper"
		@page-size-change="handleChangePageSize"
		@selection-change="handleSelectChange"
		@select-all="tableSelectAll"
		@row-click="handlePreview"
	>
		<div v-if="this.$auth[627]" slot="extra">
...
export default {
	...
	computed: {
		listInfo() {
			return this.$store.state.contentSatoolkitManage.listInfo;
		}
	},
	methods: {
		loadData(page, pageSize) {
			...
			return this.request({
				url: 'CONTENT_SATOOLKIT_MANAGE_LIST_GET',
				type: 'GET',
				param: {
					...query,
					page,
		...
		handleDelateAll() {
			...
			Confirm.popup({
				...
				// 进行指派
				this.request({
					url: '_CONTENT_SERVICE_MATERIAL_BATCH_DELATE_POST',
					type: 'POST',
					param: {
