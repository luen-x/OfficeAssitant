<template>
	...
	>
		...
		>
			<i-form-item label="类目名称：" prop="title">
				<i-input v-model="formData.title" :maxlength="10" placeholder="请输入类目名称" style="width: 220px"/>
			</i-form-item>
		</i-form>
	</i-modal>
</template>
...
export default {
	...
	data() {
		return {
			...
			rules: {
				title: [{ required: true, type: 'string', message: "请输入类目名称", trigger: "blur" }]
			},
