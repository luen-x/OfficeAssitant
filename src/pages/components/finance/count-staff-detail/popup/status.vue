<template>
	<i-modal
		...
		:mask-closable="false"
		width="400"
		class="v-finance-count-staff-detail-status-modal"
		@on-ok="handleOk"
	...
	>
		<div
			...
			class="g-tc"
		>修改记录</div>
		<div v-if="obj.length" class="_content">
			<oa-steps
				:data-source="obj"
				:type="1"
		...
		<div v-else class="g-flex g-flex-ac g-flex-cc g-m-t-30">
			暂无数据，请稍后再试。
		</div>
	</i-modal>
</template>
...
export default {
	name: "v-finance-count-staff-detail-status-modal",
	components: {
		"i-modal": Modal,
		"i-progress": Progress,
		"oa-steps": Steps
...
<style lang="scss">
.v-finance-count-staff-detail-status-modal {
	.ivu-modal-content {
		.ivu-modal-body {
