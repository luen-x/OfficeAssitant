<template>
	<div class="g-m-b-30 v-sc-manage-inspection-complaint">
		<div v-if="spin" class="_detail-content">
			<div>
				<div>
					<div class="__title g-m-t-30 g-m-b-20">
						<span class="__label g-c-black3 g-pd-l-15 g-fs-14">投诉记录</span>
					</div>
						...
						<div v-for="(item,index) in list" :key="index" class="__content">
							<div class="__item g-pd-10 g-m-b-10 g-pd-l-10 g-pd-r-10">
								...
								>
									...
									<div v-if="option" style="color:#2397F9;">
										<span 
											v-if="edit"
											class="g-pointer" 
...
export default {
	name: "sc-manage-inspection-complaint",
...
<style lang="scss">
.v-sc-manage-inspection-complaint {
