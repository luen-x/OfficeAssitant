<template>
	<div class="v-sc-cooperate-look-email">
...
import { Expand, Editor } from "wya-vc";
...
export default {
	...
	methods: {
		loadData() {
			this.$request({
				url: API_ROOT._SC_CUSTOMER_COOPERATE_LOOK_EMAIL_DETAIL_GET,
				type: "GET",
				param: {
		...
		handleEdit() {
			setItem(`look_mail_${this.$global.version}`, JSON.stringify(this.detail));
