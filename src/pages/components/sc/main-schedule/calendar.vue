<template>
	<div>
		<vc-calendar
			ref="calendar"
			lang="ch"
			class="v-sc-main-sched-calendar g-m-t-20"
		...
		>
			...
			<div slot-scope="it" class="_day">
				...
				<div class="_add-btn g-flex-cc" @click="handleAddSched(it.data.date)">
					<i class="iconfont icon-add2 g-fs-12"/>
					添加提醒事项
				</div>
			</div>
		</vc-calendar>
...
export default {
	...
	computed: {
		todoList() {
			return this.$store.state.scMainSchedule.data;
		}
	},
...
.v-sc-main-sched-calendar {
    ...
    ._cur-day {
        ...
        box-shadow: 0px 2px 6px #e8485499;
        margin-right: -12px;
    }
