<template>
	<div 
		...
		class="v-sale-train-employee-orientation g-relative"
	>
...
export default {
	name: "oa-train-employee-orientation",
	components: {
		'oa-loading': Loading,
	...
	methods: {
		...
		loadData() {
			...
			this.loading = true;
			this.$request({
				url: API_ROOT._SALE_TRAIN_EMPLOYEE_PRE_TRAIN_GET,
				type: 'GET',
				loading: false,
				param: {
...
export const TrainEmployeeOrientation = module.exports.default;
</script>
<style lang="scss">
