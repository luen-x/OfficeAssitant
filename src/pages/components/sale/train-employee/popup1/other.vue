<template>
	<div 
		...
		class="v-sale-train-employee-other g-relative"
	>
...
export default {
	...
	methods: {
		...
		loadData() {
			...
			this.loading = true;
			this.$request({
				url: API_ROOT._SALE_TRAIN_EMPLOYEE_OTHER_PROJECT_GET,
				type: 'GET',
				loading: false,
				param: {
...
export const TrainEmployeeOther = module.exports.default;
</script>
<style lang="scss">
