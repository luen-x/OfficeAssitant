...
export const SeaAddContact = CreatePortal({}, module.exports.default);
</script>
<style lang="scss">
.v-sale-sea-add-contact {
	.ivu-modal-body {
		max-height: 500px;
		overflow-y: auto;
		padding: 16px 0;
