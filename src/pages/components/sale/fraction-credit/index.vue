<template>
	<div class="v-sale-fraction-credit">
		<div class="g-flex g-jc-fe g-m-b-20">
			<i-button 
				v-if="$auth[518]" 
				class="_btn" 
				@click="handleCreditSub"
			>
				下级学分
			</i-button>
			<i-button 
				v-if="$auth[520]" 
				class="_btn g-m-l-5" 
				@click="handleCreditApplication"
			>
				学分申请
			</i-button>
		</div>
		<oa-fraction-basic-info :staff-info="staff_info"/>
		<div class="_tab-credit g-m-t-10">
			<i-tabs
				value="month"
			...
			>
				...
				>
					<oa-fraction-index>
						<oa-fraction-index-month slot="month" :month-info="month_info" type="学分"/>
					</oa-fraction-index>
				</i-tab-pane>
				<i-tab-pane 
					label="年度学分" 
				...
				>
					<oa-fraction-index>
						<oa-fraction-index-year slot="year" :year-info="year_info" type="学分"/>
					</oa-fraction-index>
				</i-tab-pane>
			</i-tabs>
		</div>
		...
		<i-collapse v-model="arrow" simple>
			<i-panel :hide-arrow="true" name="1">
				...
				<div slot="content">
					<oa-fraction-detail :detail="detail" fraction-type="学分详情"/>
				</div>
			</i-panel>
		</i-collapse>
		<div class="_integral-detail g-fs-14 g-m-tb-20">
