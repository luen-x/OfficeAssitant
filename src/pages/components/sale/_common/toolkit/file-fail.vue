<template>
	<div class="v-sale-fail-content g-flex g-fd-c g-jc-c g-ai-c">
		<div 
			v-if="(fileType === 1 || !fileType) && fileUrl && !isDelete" 
		...
		<div 
			v-else-if="fileType === 4 && fileUrl && !isDelete" 
			class="g-flex g-fd-c g-jc-c g-ai-c _box"
		>
			<img :src="OSS_SEARCH_CUSTOMER" alt="" class="__img">
			<div class="g-fs-18 g-m-t-10 g-flex">
		...
		<div 
			v-else-if="fileType === 5 && fileUrl && !isDelete" 
			class="g-flex g-fd-c g-jc-c g-ai-c _box"
		>
			<img :src="OSS_SEARCH_CUSTOMER" alt="" class="__img">
			<div class="g-fs-18 g-m-t-10 g-flex">
		...
		<div 
			v-else-if="fileType === 2 && fileUrl && !isDelete && isBig" 
			class="g-flex g-fd-c g-jc-c g-ai-c _box"
		>
			<img :src="OSS_SEARCH_CUSTOMER" alt="" class="__img">
			<div class="g-fs-18 g-m-t-10 g-flex">
