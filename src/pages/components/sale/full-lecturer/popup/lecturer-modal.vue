...
import { Modal, DatePicker, Message, Select, Option, Table, Page } from 'iview';
...
export default {
	...
	methods: {
		...
		async loadTableData(page) {
			...
			let obj = {
				type: 2,
				start_date: moment(this.time[0]).format("YYYY-MM-DD"),
				end_date: moment(this.time[1]).format("YYYY-MM-DD"),
