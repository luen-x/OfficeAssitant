<template>
	...
	>
		...
		<div class="g-fs-14 g-flex g-ai-c g-flex-ac _content">
		...
		<div slot="footer" class="_footer">
			<span 
				class="g-c-blue-mid g-fs-14 g-pointer g-m-l-20 g-fl"
				@click="handleExportModel">下载导入模板</span>
...
export default {
	...
	methods: {
		...
		handleOk() {
			...
			fetch(API_ROOT._ADMINISTRATION_PHONE_IMPORT_PHONE_POST, {
				method: 'post',
				body: data,
				headers: {
		...
		handleExportModel() {
			const url = getHashUrl(API_ROOT['_ADMINISTRATION_PHONE_DOWNLOAD_TEMPLATE_GET'], {
