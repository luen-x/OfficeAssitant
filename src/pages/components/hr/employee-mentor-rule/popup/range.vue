...
export default {
	...
	methods: {
		...
		handleSelectPosition(position) {
			this.formData.position_id = position.value;
			this.formData.position_name = position.label.trim();
		},
		handleSelectRole(role) {
			this.formData.role_id = role.value;
			this.formData.role_name = role.label.trim();
		}
	}
};
