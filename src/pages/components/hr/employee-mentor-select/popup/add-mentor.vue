...
export default {
	...
	methods: {
		handleOk() {
			this.$request({
				url: API._HR_ARCHIVES_ADD_EVALUATE_POST,
				type: "POST",
				loading: false,
				param: {
		...
		loadData(page) {
			...
			this.$request({
				url: API._HR__MASTER_EVALUATE_SEARCH_LIST_GET,
				type: "GET",
				loading: false,
				param: {
					page: page || 1,
...
export const AddMentor = CreatePortal({}, module.exports.default);
</script>
<style lang="scss" >
