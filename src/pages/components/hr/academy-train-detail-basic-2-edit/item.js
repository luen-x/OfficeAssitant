export default {
	data() {
		...
		// 		&& this.formData.echelon.attend_members1.length == 0) {
		...
		// 	if (this.formData.echelon.participant_type.includes(2)
		// 		&& this.formData.echelon.attend_members2_data.length == 0) {
		...
		return {
			...
			echelonData: [], // 人才梯队数据
			rules: {
				course_name: [{ required: true, message: '请输入课程名称', trigger: 'blur' }], // 课程名称
