				...
				},
				{
					...
					render: (h, params) => {
						return h(
							...
							[
								h('span', {}, [
									this.$auth[1141] ? (params.row._disabled === false ? h('span', {
									...
									(this.$auth[1141] && this.$auth[1142]) ? (params.row._disabled === false ? h('span', {
										style: {
											paddingLeft: '3px',
											paddingRight: '3px'
										}
									...
									this.$auth[1142] ? (params.row._disabled === false ? h('span', {
										class: "g-c-blue-mid g-pointer",
										on: {
											click: (e) => {
