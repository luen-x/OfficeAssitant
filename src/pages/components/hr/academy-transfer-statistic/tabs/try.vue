<template>
	<div class="v-hr-academy-transfer-statistic-try">
	...
	methods: {
		loadData() {
			...
			let url = this.subtype === 'recruit'
				? 'HR_ACADEMY_TRANSFER_STATISTIC_TRY_RECRUIT_GET'
				: 'HR_ACADEMY_TRANSFER_STATISTIC_TRY_ORGANIZATION_GET';
...
.v-hr-academy-transfer-statistic-try {
	._statistic {
		width: 100%;
		height: 114px;
		padding-top: 20px;
