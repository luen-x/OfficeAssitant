<template>
	...
	<div class="g-c-black1 g-flex-ac g-fw-w g-m-b-10" style="margin-top: -10px; line-height: 50px">
		...
		<i-form-item>&nbsp; 业绩不低于 &nbsp;</i-form-item>
		<i-form-item
			:rules="ruleValidate.total_performance"
			:prop="'periods.' + periodIndex + '.ranks.' + rankIndex +'.rules.' + index + '.total_performance'"
		>
			<i-input-number
				v-model="rule.total_performance" 
				:precision="2"
				:max="99999999"  
				:min="0"
				:active-change="false" 
