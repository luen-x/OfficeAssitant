<template>
	<div class="v-collage-customer-information g-relative g-pd-l-20">
		<div v-if="spin" class="g-m-t-30">
			<div>
				<div 
					class="g-fs-14 g-c-black3 g-lh-16 g-pd-l-10 g-m-b-15"
...
export default {
	name: "collage-customer-information",
...
<style lang="scss">
.v-collage-customer-information {
	min-height: 300px;
