<template>
	<div>
		<i-modal
			...
			:mask-closable="false"
			title="唱单补贴"
			class="v-collage-setting-subsidy-sing-modal"
			@on-ok="handleOk"
...
export const SingModal = CreatePortal({}, module.exports.default);
</script>

<style lang="scss">
.v-collage-setting-subsidy-sing-modal {
	.ivu-modal-body {
		max-height: 400px;
		overflow-y: auto;
	}
