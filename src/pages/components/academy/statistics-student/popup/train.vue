<template>
	<div class="v-academy-statistics-student-train g-pd-t-10">
		<div
				...
				<div class="g-pd-20 __content">
					<div class="g-flex">
						<div style="width: 160px;">
							...
							<span v-if="item.lecture.length < 7" class="g-c-black1">
								{{ item.lecture }}
							</span>
							<i-tooltip
								v-else
					...
					<div class="g-flex g-m-t-15">
						<div style="width: 240px;">
							...
							<span v-if="item.apply_time" class="g-c-black4">
								（{{ item.apply_time }}）
							</span>
						</div>
						<div style="width: 240px;">
							...
							<span v-if="item.sign_time" class="g-c-black4">
								（{{ item.sign_time }} ）
							</span>
						</div>
						<div style="width: 240px;">
...
import { Page, Tooltip } from "iview";
...
<style lang="scss">
.v-academy-statistics-student-train{
	position: relative;
