	...
	>
		...
		>
			...
			<vc-paging
				...
				class="v-statistic-business-customer-renew-list"
				mode="table"
...
export default {
	...
	data() {
		...
		return {
			...
			typeUrl: {
				1: 'STATISTIC_BUSINESS_CUSTOMER_RENEW_LIST_GET',
				2: 'STATISTIC_BUSINESS_CUSTOMER_RENEW_LIST2_GET',
				3: 'STATISTIC_BUSINESS_CUSTOMER_RENEW_LIST3_GET',
			}
		};
	},
	computed: {
		listInfo() {
			return this.$store.state.statisticBusinessCustomerRenew.listInfo;
		}
	},
	methods: {
		loadData(page, pageSize) {
			...
			return this.request({
				...
				redirect: "STATISTIC_BUSINESS_CUSTOMER_RENEW_LIST_GET_SUCCESS",
				type: 'GET',
				param: {
					..._query,
					type: this.type,
		...
		handleChange(type) {
			...
			this.$router.replace(getHashUrl('/statistic/business/customer/renew', { ...query }));
		},
