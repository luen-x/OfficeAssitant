<template>
	<vc-paging
		...
		mode="table"
		class="g-m-t-20 v-statistic-business-customer-deal-industry-list"
...
export default {
	...
	computed: {
		listInfo() {
			return this.$store.state.statisticBusinessCustomerDealIndustry.listInfo;
		}
	},
	methods: {
		loadData(page, pageSize) {
			...
			return this.request({
				url: 'STATISTIC_BUSINESS_CUSTOMER_DEAL_INDUSTRY_LIST_GET',
				type: 'GET',
				param: {
