<template>
	<vc-paging
		...
		mode="table"
		class="g-m-t-20 v-statistic-business-customer-deal-area-list"
...
export default {
	...
	computed: {
		listInfo() {
			return this.$store.state.statisticBusinessCustomerDealArea.listInfo;
		}
	},
	methods: {
		loadData(page, pageSize) {
			...
			return this.request({
				url: 'STATISTIC_BUSINESS_CUSTOMER_DEAL_AREA_LIST_GET',
				type: 'GET',
				param: {
